...
CFLAGS = -mmcu=$(GCC_MCU) -DF_CPU=$(F_CPU)UL -DBAUD=$(BAUD) -Os -I. -I$(EXTRA_SOURCE_DIR)
...
debug:
	...
	@echo "MCU, F_CPU, BAUD:"  $(GCC_MCU), $(F_CPU), $(BAUD)
	@echo "AVRDUDE Device (MCU):" $(AVRDUDE_MCU)
	@echo
...
size:  $(TARGET).elf
	$(AVRSIZE) -C --mcu=$(GCC_MCU) $(TARGET).elf
...
avrdude_terminal:
	$(AVRDUDE) -c $(PROGRAMMER_TYPE) -p $(AVRDUDE_MCU) $(PROGRAMMER_ARGS) -nt
